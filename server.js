...
const server = http.createServer(async (req, res) => {
  if (req.url === '/test') {
    ...
    await sendNotification(
      '🧪 EMA Server Test',
      'Your EMA Precision Alert Server is working! 🎉
Notifications will fire during London+NY session when BTC is bullish and a Touching signal is detected.',
      'high',
      'white_check_mark'
    );
    ...
    res.writeHead(200, { 'Content-Type': 'text/plain' });
    res.end('EMA Precision Scanner running ✅
